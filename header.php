...
<html <?php language_attributes(); ?>>
    <head profile="http://www.w3.org/1999/xhtml/vocab"> 
		...
		<meta name="ahrefs-site-verification" content="e22251d4838a40d50a69b83adaa6386492164dbaa1d95fa5c53944543acce7f2">
    ...
    <body <?php body_class(); ?>>    
        ...
        <header>
            <div class="uk-container">
                <div class="uk-flex uk-flex-between uk-flex-middle uk-flex-center@m">
                    <div>
                        <?php
                        $logo = get_field('header_logo', 'option');
                        $offcanvasLogo = get_field('offcanvas_logo', 'option');?>
                        <a class="uk-logo uk-visible@m uk-preserve" href="<?php echo site_url(); ?>/shop/"><img class="uk-preserve" src="<?php echo $logo['url']; ?>" title="<?php echo $logo['title']; ?>" alt="<?php echo $logo['alt']; ?>" height="95" width="100" uk-svg></a>
                        <a class="uk-logo uk-hidden@m" href="<?php echo site_url(); ?>/shop/"><img class="uk-preserve" src="<?php echo $offcanvasLogo['url']; ?>" title="<?php echo $offcanvasLogo['title']; ?>" alt="<?php echo $offcanvasLogo['alt']; ?>" height="60" width="100" uk-svg></a>
                    </div>
            ...
            <nav class="uk-navbar-container uk-navbar-transparent uk-margin-top uk-visible@m">
                <div class="uk-container">
                    <div uk-navbar>
