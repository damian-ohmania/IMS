...
class UIKit_Menu_Walker extends Walker {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if( $depth == 0) {
			$output .= "\n$indent<div class=\"uk-navbar-dropdown top-dropdown\" uk-dropdown=\"pos: bottom-justify;mode:click\"><ul class=\"uk-nav uk-navbar-dropdown-nav\">\n";
		}
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        /* If this item has a dropdown menu, add the 'dropdown' class for UIKit */
        if ($item->hasChildren) {
            $classes[] = 'uk-parent';
        }
		/**
		...
		if ($item->hasChildren && $depth == 0) {
			...
			if ($this->is_offcanvas) {
				...
				$item_output .= ' <span uk-icon="chevron-down"></span>';
			}
